        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (0 === strpos($pathinfo, '/blog/a')) {
                ...
                if (0 === strpos($pathinfo, '/blog/article') && preg_match('#^/blog/article/(?P<id>\\d*)$#s', $pathinfo, $matches)) {
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'evry_thing_blog_VoirArticle')), array (  '_controller' => 'EvryThing\\BlogBundle\\Controller\\BlogController::voirArticleAction',));
                }

                // evry_thing_blog_ajouterArticle
                if ($pathinfo === '/blog/ajouter') {
                    return array (  '_controller' => 'EvryThing\\BlogBundle\\Controller\\BlogController::ajouterArticleAction',  '_route' => 'evry_thing_blog_ajouterArticle',);
                }

            }

            // evry_thing_blog_modifierArticle
            if (0 === strpos($pathinfo, '/blog/modifier') && preg_match('#^/blog/modifier/(?P<id>\\d*)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'evry_thing_blog_modifierArticle')), array (  '_controller' => 'EvryThing\\BlogBundle\\Controller\\BlogController::modifierArticleAction',));
            }

            // evry_thing_blog_supprimerArticle
            if (0 === strpos($pathinfo, '/blog/supprimer') && preg_match('#^/blog/supprimer/(?P<id>\\d*)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'evry_thing_blog_supprimerArticle')), array (  '_controller' => 'EvryThingBlogBiundle:Blog:supprimerArticle',));
            }

            // evry_thing_blog_ajouterCommentaire
            if ($pathinfo === '/blog/ajouterCom') {
                return array (  '_controller' => 'EvryThing\\BlogBundle\\Controller\\BlogController::ajouterComAction',  '_route' => 'evry_thing_blog_ajouterCommentaire',);
            }
