<?php
// src/EvryThing/BlogBundle/Antispam/EvryThingAntiSpam.php

namespace EvryThing\BlogBundle\AntiSpam;

class EvryThingAntiSpam
{
  protected $mailer;
  protected $locale;
  protected $nbForSpam;
...
urn ($this->countLinks($text) + $this->countMails($text)) >= 3;
  }
